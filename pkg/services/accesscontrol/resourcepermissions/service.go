...
func (s *Service) SetUserPermission(ctx context.Context, orgID, userID int64, resourceID string, actions []string) (*accesscontrol.ResourcePermission, error) {
	...
	return s.onSetUser(ctx, orgID, userID, resourceID, permission)
}

func (s *Service) onSetUser(ctx context.Context, orgID, userID int64, resourceID string, permission *accesscontrol.ResourcePermission) (*accesscontrol.ResourcePermission, error) {
...
func (s *Service) onSetTeam(ctx context.Context, orgID, teamID int64, resourceID string, permission *accesscontrol.ResourcePermission) (*accesscontrol.ResourcePermission, error) {
...
func (s *Service) onSetBuiltInRole(ctx context.Context, orgID int64, builtInRole, resourceID string, permission *accesscontrol.ResourcePermission) (*accesscontrol.ResourcePermission, error) {
	if s.options.OnSetTeam != nil {
